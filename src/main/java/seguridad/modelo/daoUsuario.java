...
public class daoUsuario {
    ...
    private static final String SQL_SELECT = "SELECT usuid, usunombre, usucontrasena, usuestatus, usunombrereal, usucorreoe, usutelefono, usudireccion, usutipo FROM proyectobd122022.tbl_usuario";
    private static final String SQL_INSERT = "INSERT INTO proyectobd122022.tbl_usuario (usunombre, usucontrasena, usuestatus, usunombrereal, usucorreoe, usutelefono, usudireccion, usutipo) VALUES(?, ?, ?, ?, ?, ?, ?, ?)";
    private static final String SQL_UPDATE = "UPDATE proyectobd122022.tbl_usuario SET usunombre=?, usucontrasena=?, usuestatus=?, usunombrereal=?, usucorreoe=?, usutelefono=?, usudireccion=?, usutipo=? WHERE usuid = ?";
    private static final String SQL_DELETE = "DELETE FROM tbl_usuario WHERE usuid=?";
    private static final String SQL_QUERY = "SELECT usuid, usunombre, usucontrasena, usuestatus, usunombrereal, usucorreoe, usutelefono, usudireccion, usutipo FROM proyectobd122022.tbl_usuario WHERE usuid=?";
    private static final String SQL_QUERYN = "SELECT usuid, usunombre, usucontrasena, usuestatus, usunombrereal, usucorreoe, usutelefono, usudireccion, usutipo FROM proyectobd122022.tbl_usuario WHERE usunombre=?";    
