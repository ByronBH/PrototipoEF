...
public class frmMantenimientoTipopago extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        modelo.addColumn("Nombre");
         daoTipopago cDAO = new daoTipopago();
        List<clsTipopago> c = cDAO.select();
        tablaLineas.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < c.size(); i++) {
            dato[0] = Integer.toString(c.get(i).getTipcodigo());
            dato[1] = c.get(i).getTipnombre();
    ...
    public void buscaraplicacion() {
        clsTipopago cAConsultar = new clsTipopago();
        daoTipopago cDAO = new daoTipopago();
        cAConsultar.setTipcodigo(Integer.parseInt(txtbuscado.getText()));
        cAConsultar = cDAO.query(cAConsultar);
        txtNombre.setText(cAConsultar.getTipnombre());
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Mantenimiento Tipo de pago");
        setVisible(true);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        daoTipopago cDAO = new daoTipopago();
        clsTipopago cAEliminar = new clsTipopago();
        cAEliminar.setTipcodigo(Integer.parseInt(txtbuscado.getText()));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        daoTipopago cDAO = new daoTipopago();
        clsTipopago cAInsertar = new clsTipopago();
        cAInsertar.setTipnombre(txtNombre.getText());
...
//        // TODO add your handling code here:
        daoTipopago cDAO = new daoTipopago();
        clsTipopago cAActualizar = new clsTipopago();
        cAActualizar.setTipcodigo(Integer.parseInt(txtbuscado.getText()));
        cAActualizar.setTipnombre(txtNombre.getText());
