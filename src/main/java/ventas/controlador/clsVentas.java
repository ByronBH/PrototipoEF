...
public class clsVentas {
    ...
    this.veedocumento = veedocumento;
     ...
     public clsVentas(String veedocumento, int clicodigo, String veefecha, int veetotal, String veeestatus, String vedestatus,int Tipcodigo, 
...
public String Getveedocumento() {
    ...
    public String toString() {
         return "tbl_vendedores{" + "veedocumento =" + veedocumento + ", clicodigo=" + clicodigo + ", veefecha=" + veefecha + ", veetotal=" + veetotal +", veeestatus=" + veeestatus +", Tipcodigo=" + tipcodigo +", prodcodigo=" + prodcodigo +", vedcantidad=" + vedcantidad +", vedprecio=" + vedprecio +", bodcodigo=" + bodcodigo + '}';
    }
