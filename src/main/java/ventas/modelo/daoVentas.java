...
public class daoVentas {
    ...
    private static final String SQL_SELECT2 = "SELECT veedocumento, tipcodigo, prodcodigo, vedcantidad, vedprecio, bodcodigo FROM tbl_ventas_detalle";
    ...
    private static final String SQL_INSERT2 = "INSERT INTO tbl_ventas_detalle(veedocumento, tipcodigo, prodcodigo, vedcantidad, vedprecio, bodcodigo) VALUES( ?, ?, ?, ?, ?, ?)";
    ...
    //private static final String SQL_UPDATE2 = "UPDATE tbl_ventas_detalle SET tipcodigo=?, prodcodigo=?, vedcantidad=?, vedprecio=?, bodcodigo=? WHERE veedocumento = ?";
    private static final String SQL_UPDATE2 = "UPDATE proyectobd122022.tbl_ventas_detalle SET tipcodigo = ?, prodcodigo = ?, vedcantidad = ?, vedprecio = ?, bodcodigo = ? WHERE (veedocumento = ?)";
    ...
    private static final String SQL_QUERY2 = "SELECT veedocumento, tipcodigo, prodcodigo, vedcantidad, vedprecio, bodcodigo FROM tbl_ventas_detalle WHERE veedocumento = ?";
    ...
    public List<clsVentas> select() {
        ...
        try {
            ...
            while (rs.next()) {
                String veedocumento = rs.getString("veedocumento");
                int tipcodigo = rs.getInt("tipcodigo");
    ...
    public int insert(clsVentas vanta) {
        ...
        try {
            ...
            stmt.setString(1, vanta.Getveedocumento());
            stmt.setInt(2, vanta.GetTipcodigo());
    ...
    public int update(clsVentas vanta) {
        ...
        try {
            ...
            stmt.setInt(1, vanta.GetTipcodigo());
