...
import logistica.modelo.daoTipopago;
...
public class frmMantenimientoVentas extends javax.swing.JInternalFrame {
    ...
    public void ComboCliente() {
        ...
        public void estados() {    
        cbox_veeestatus.addItem("A");
        cbox_veeestatus.addItem("I");
    }
        ...
        daoTipopago VentasDAO = new daoTipopago();
        List<clsTipopago> ventas = VentasDAO.select();
        cbox_tipcodigo.addItem("Seleccione un Tipo de pago");
        //cbox_clicodigo.removeAllItems();
        for (int i = 0; i < ventas.size(); i++) {
            cbox_tipcodigo.addItem(String.valueOf(ventas.get(i).getTipcodigo()));
        }
    }
    ...
    public void llenadoDeTablas() {
        ...
        for (int i = 0; i < ventas.size(); i++) {
            ...
            dato[5] = Integer.toString(ventas2.get(i).GetTipcodigo());//DETALLE
    ...
    public void buscarVendedor() {
        ...
        txtOrdenID.setText(Integer.toString(ventasAConsultar2.GetTipcodigo()));
        ...
        cbox_bodcodigo.setSelectedItem(Integer.toString(ventasAConsultar2.Getbodcodigo()));
         cbox_tipcodigo.setSelectedItem(Integer.toString(ventasAConsultar2.GetTipcodigo()));
    ...
    private void initComponents() {
        ...
        cbox_bodcodigo1 = new javax.swing.JComboBox<>();
        cbox_tipcodigo = new javax.swing.JComboBox<>();
        ...
        label10.setText("Tipo de pago");
        getContentPane().add(label10, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 390, -1, -1));

        label11.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        label11.setText("Codigo Producto");
        getContentPane().add(label11, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 240, -1, -1));

        label12.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        label12.setText("Cantidad");
        getContentPane().add(label12, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 280, -1, -1));

        label14.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        label14.setText("Precio");
        getContentPane().add(label14, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 310, -1, -1));

        label15.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        label15.setText("Bodega ID");
        getContentPane().add(label15, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 350, -1, -1));
        ...
        getContentPane().add(txtOrdenID, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 390, 263, -1));
        ...
        getContentPane().add(txtCantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 280, 263, -1));
        ...
        getContentPane().add(txtPrecio, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 310, 263, -1));
        ...
        getContentPane().add(cbox_prodcodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 240, 263, -1));
        ...
        getContentPane().add(cbox_bodcodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 350, 263, -1));
        ...
        cbox_bodcodigo1.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        cbox_bodcodigo1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbox_bodcodigo1ActionPerformed(evt);
            }
        });
        getContentPane().add(cbox_bodcodigo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 350, 263, -1));

        cbox_tipcodigo.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        cbox_tipcodigo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbox_tipcodigoActionPerformed(evt);
            }
        });
        getContentPane().add(cbox_tipcodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 410, 263, -1));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        ventasAInsertar2.SetTipcodigo(Integer.parseInt(txtOrdenID.getText()));
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        vendedorAActualizar2.SetTipcodigo(Integer.parseInt(txtOrdenID.getText()));
        ...
        vendedorAActualizar2.Setprodcodigo(Integer.parseInt(cbox_tipcodigo.getSelectedItem().toString()));
    ...
    private void btnLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimpiarActionPerformed
        ...
        cbox_tipcodigo.setSelectedIndex(0);
        txtbuscado.setText("");
    ...
    private void cbox_bodcodigo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbox_bodcodigo1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbox_bodcodigo1ActionPerformed

    private void cbox_tipcodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbox_tipcodigoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbox_tipcodigoActionPerformed
    ...
    private javax.swing.JComboBox<String> cbox_bodcodigo1;
    private javax.swing.JComboBox<String> cbox_clicodigo;
    private javax.swing.JComboBox<String> cbox_prodcodigo;
    private javax.swing.JComboBox<String> cbox_tipcodigo;
